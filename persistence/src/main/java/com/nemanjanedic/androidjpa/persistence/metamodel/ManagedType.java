...
/**
 * Instances of the type <code>ManagedType</code> represent entity, mapped superclass, and
 * embeddable types.
 *
 * @param <X> The represented type.
 * @since Java Persistence 2.0
 */
public interface ManagedType<X> extends javax.persistence.metamodel.Type<X> {
    ...
    /**
     * Return the attributes declared by the managed type. Returns empty set if the managed type
     * has
     * no declared
     * attributes.
     *
    ...
    /**
     * Return the single-valued attribute of the managed type that corresponds to the specified
     * name
     * and Java type.
     *
     ...
     * @throws IllegalArgumentException if attribute of the given name and type is not present in
     *                                  the managed type
     */
    <Y> SingularAttribute<? super X, Y> getSingularAttribute(String name, Class<Y> type);

    /**
     * Return the single-valued attribute declared by the managed type that corresponds to the
     ...
     * @throws IllegalArgumentException if attribute of the given name and type is not declared in
     *                                  the managed type
     */
    <Y> SingularAttribute<X, Y> getDeclaredSingularAttribute(String name, Class<Y> type);

    /**
     * Return the single-valued attributes of the managed type. Returns empty set if the managed
     * type has no
    ...
    /**
     * Return the single-valued attributes declared by the managed type. Returns empty set if the
     * managed type has no
    ...
    /**
     * Return the Collection-valued attribute of the managed type that corresponds to the specified
     * name and Java
     * element type.
     *
     * @param name        the name of the represented attribute
    ...
    /**
     * Return the Collection-valued attribute declared by the managed type that corresponds to the
     * specified name and
     * Java element type.
     *
     * @param name        the name of the represented attribute
    ...
    /**
     * Return the Set-valued attribute declared by the managed type that corresponds to the
     * specified name and Java
     * element type.
     *
     * @param name        the name of the represented attribute
    ...
    /**
     * Return the List-valued attribute declared by the managed type that corresponds to the
     * specified name and Java
     * element type.
     *
     * @param name        the name of the represented attribute
    ...
    /**
     * Return the Map-valued attribute declared by the managed type that corresponds to the
     * specified name and Java key
     * and value types.
     *
     * @param name      the name of the represented attribute
     * @param keyType   the key type of the represented attribute
    ...
    /**
     * Return all multi-valued attributes (Collection-, Set-, List-, and Map-valued attributes) of
     * the managed type.
    ...
    /**
     * Return all multi-valued attributes (Collection-, Set-, List-, and Map-valued attributes)
     ...
     * @throws IllegalArgumentException if attribute of the given name is not present in the
     *                                  managed
     *                                  type
     */
     ...
     * @param name the name of the represented attribute
     * @return attribute with given name
     * @throws IllegalArgumentException if attribute of the given name is not declared in the
     *                                  managed type
     */
